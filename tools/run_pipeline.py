...
try:
    ...
    from jspace_integration import JSpaceManager, JSpaceError, validate_jspace_script
...
def finish(slug, offline=False, ack=None, skip_source_voice=False, skip_title_match=False):
    ...
    if JSPACE_AVAILABLE:
        ...
        print("[提示] J-Space不可用，跳过阶段4沉淀接缝审计")
